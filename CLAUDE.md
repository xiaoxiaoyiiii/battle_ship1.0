...
> 最后更新：2026-09-18（段位/排位批）。

---

## 0. 速览

Flask + Flask-SocketIO 的实时双人海战棋，43 条魔法卡 / 场地魔法 / 连锁系统；含账号、战绩排行、段位与排位、等级经验、名片外观、人机、自定义房、断线重连。
...
`docs/MOBILE_ADAPTIVE_LAYOUT.md`（移动端布局）｜ `docs/UI_REVIEW_FIXES.md`（UI 审查）｜ `README.md`（用户向说明）
